...
from langchain.embeddings import HuggingFaceEmbeddings  # Not used in this version
...
def get_vectorstore(text_chunks):
  ...
  print(f"Using Hugging Face API key: {api_key[:4]}...{api_key[-4:]}")  # Print first and last 4 characters for verification
